...
var _default = {
  ...
  encrypt: async function (m, p, g, y) {
    ...
    const yred = y.toRed(redp); // See Section 11.5 here: https://crypto.stanford.edu/~dabo/cryptobook/BonehShoup_0_4.pdf

    const k = await _random.default.getRandomBN(zero, p); // returns in [0, p-1]
