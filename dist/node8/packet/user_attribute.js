...
function UserAttribute() {
  this.tag = _enums.default.packet.userAttribute;
  this.attributes = [];
}
/**
...
UserAttribute.prototype.read = function (bytes) {
  ...
  while (i < bytes.length) {
    ...
    i += len.offset;
    this.attributes.push(_util.default.Uint8Array_to_str(bytes.subarray(i, i + len.len)));
    i += len.len;
  }
};
/**
...
UserAttribute.prototype.write = function () {
  ...
  for (let i = 0; i < this.attributes.length; i++) {
    arr.push(_packet.default.writeSimpleLength(this.attributes[i].length));
    arr.push(_util.default.str_to_Uint8Array(this.attributes[i]));
  }
