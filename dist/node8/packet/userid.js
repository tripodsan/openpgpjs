 ...
 */
function Userid() {
  this.tag = _enums.default.packet.userid;
...
Userid.prototype.read = function (bytes) {
  this.parse(_util.default.decode_utf8(bytes));
};
/**
...
Userid.prototype.parse = function (userid) {
  try {
    Object.assign(this, _util.default.parseUserId(userid));
  } catch (e) {}
...
Userid.prototype.write = function () {
  return _util.default.encode_utf8(this.userid);
};
/**
...
Userid.prototype.format = function (userid) {
  if (_util.default.isString(userid)) {
    userid = _util.default.parseUserId(userid);
  }

  Object.assign(this, userid);
  this.userid = _util.default.formatUserId(userid);
};
