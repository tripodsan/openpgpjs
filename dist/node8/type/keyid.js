...
Keyid.prototype.read = function (bytes) {
  this.bytes = _util.default.Uint8Array_to_str(bytes.subarray(0, 8));
};

Keyid.prototype.write = function () {
  return _util.default.str_to_Uint8Array(this.bytes);
};

Keyid.prototype.toHex = function () {
  return _util.default.str_to_hex(this.bytes);
};
/**
...
Keyid.fromId = function (hex) {
  const keyid = new Keyid();
  keyid.read(_util.default.hex_to_Uint8Array(hex));
  return keyid;
};
