...
function OID(oid) {
  if (oid instanceof OID) {
    this.oid = oid.oid;
  } else if (_util.default.isArray(oid) || _util.default.isUint8Array(oid)) {
...
OID.prototype.write = function () {
  return _util.default.concatUint8Array([new Uint8Array([this.oid.length]), this.oid]);
};
/**
...
OID.prototype.toHex = function () {
  return _util.default.Uint8Array_to_hex(this.oid);
};
/**
...
OID.prototype.getName = function () {
  ...
  if (_enums.default.curve[hex]) {
    return _enums.default.write(_enums.default.curve, hex);
  } else {
